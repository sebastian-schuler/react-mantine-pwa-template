 ...
 */
export function multiply_matrices(size, a, b, result) {
    const ptr0 = passArrayF64ToWasm0(a, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(b, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    var ptr2 = passArrayF64ToWasm0(result, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    wasm.multiply_matrices(size, ptr0, len0, ptr1, len1, ptr2, len2, result);
}
